<%-- Document : profilepost Created on : Oct 11, 2021, 8:13:00 PM Author : Mr
Khang --%> <%@page contentType="text/html" pageEncoding="UTF-8"%> <%@taglib
...
<div class="post-container">
    ...
    <div class="flex_cl">
        ...
        <div class="list-post"><%@include file="postBox.jsp" %></div>
    </div>
</div>
